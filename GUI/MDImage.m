...
{
	return [ [ [ MDImage alloc ] initWithFileName:filename ] autorelease ];
}

+ (MDImage*) mdImageWithData: (unsigned char*) data
{
	return [ [ [ MDImage alloc ] initWithCData:data ] autorelease ];
}
...
- (NSData*) imageData
{
	...
	NSData* data = [ [ [ NSData alloc ] initWithBytes:d length:length ] autorelease ];
