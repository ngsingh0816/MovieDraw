...
{
	return [ [ MDColor alloc ] initWithMDColor:color ];
}

+ (MDColor*) colorWithColor: (NSColor*) color
{
	return [ [ MDColor alloc ] initWithColor:color ];
}

+ (MDColor*) colorWithRed: (float) r green: (float) g blue: (float) b alpha: (float) a
{
	return [ [ MDColor alloc ] initWithRed:r green:g blue:b alpha:a ];
}

+ (MDColor*) color
{
	return [ [ MDColor alloc ] init ];
}
