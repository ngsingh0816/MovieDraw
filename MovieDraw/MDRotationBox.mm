...
{
	MDRotationBox* view = [ [ MDRotationBox alloc ] init ];
	return view;
}

+ (instancetype) mdRotationBoxWithFrame: (MDRect)rect background: (NSColor*)bkg
{
	MDRotationBox* view = [ [ MDRotationBox alloc ] initWithFrame:rect background:bkg ];
	return view;
}
...
- (instancetype)init
{
    ...
    if (self) {
		...
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Front " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:100 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Right " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:100 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Back " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:100 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Left " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:100 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Bottom " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:100 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Top " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:100 ]} ] removeBlack:YES ]);
...
- (instancetype) initWithFrame:(MDRect)rect background:(NSColor *)bkg
{
    ...
    if (self) {
		...
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Front " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:36 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Right " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:36 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Back " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:36 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Left " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:36 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Bottom " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:36 ]} ] removeBlack:YES ]);
		sides.push_back([ MDText create2DText:[ [ NSAttributedString alloc ] initWithString:@" Top " attributes:@{NSFontAttributeName: [ NSFont systemFontOfSize:36 ]} ] removeBlack:YES ]);
...
- (int) pick: (NSPoint) point
{
	...
	for (int z = 0; z < 6; z++)
	{
		...
		glUniformMatrix4fv(MDGUIProgramLocations()[MD_PROGRAM_MODELVIEWPROJECTION], 1, NO, (projection * modelView).data);
...
- (void) setFrame:(MDRect)rect animate:(unsigned int)millisec tweening:(MDTween)tween
{
	...
	for (int z = 1; z < 4; z++)
	{
		if (vao2[z])
		{
			if (glIsBuffer(vao2[z]))
				glDeleteBuffers(1, &vao2[z]);
			vao2[z] = 0;
		}
	}
}
...
- (void) draw3DView:(MDMatrix)modelView projectionMatrix:(MDMatrix)projection
{
	...
	if (!vao2[0])
	{
		...
		glGenBuffers(1, &vao2[3]);
		glGenBuffers(1, &vao2[3]);
		glBindBuffer(GL_ARRAY_BUFFER, vao2[3]);
	...
	for (int z = 0; z < 6; z++)
	{
		...
		for (int q = 0; q < 2; q++)
		{				
			glUniformMatrix4fv(MDGUIProgramLocations()[MD_PROGRAM_NORMALROTATION], 1, NO, rotation.data);
			glUniformMatrix4fv(MDGUIProgramLocations()[MD_PROGRAM_MODELVIEWPROJECTION], 1, NO, (projection * modelView).data);
			glUniform1i(MDGUIProgramLocations()[MD_PROGRAM_ENABLETEXTURES], (q == 1));
			if (q == 1)
			{
